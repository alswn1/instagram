...
<link rel="stylesheet" type="text/css" href="${cp}/css/yooncheol/E_mail2/E_mail2.css"/>
</head>
		...
		<div class="div_right">
			...
			<div style="align-items: stretch; align-content: stretch; flex: 0 0 auto;">
				<div style="text-align:center; width:100%; border: 0 solid #000;">
					<a class="etc" role="tab" href="${cp}/instagram/mypage/insta_email_security.jsp">
						<span>보안</span>
					</a>
					<a class="security" role="tab" href="${cp}/instagram/mypage/insta_email_etc.jsp">
						<span>기타</span>
					</a>
				</div>
				<div>
					<div class="center_info_cover">
						<h3 class="center_info">최근 14일 동안 Instagram에서 보낸 보안 및 로그인 외 다른 내용의 이메일이 여기에 표시됩니다. 이 리스트를 사용하여 회원님이 받은 이메일이 실제 instagram에서 보낸 것이 맞는지 확인할 수 있습니다.
