...
<link href="${cp}/css/seongho/join/join_phone_confirmation.css" rel="stylesheet" type="text/css">
...
<body>
					...
					<div class="small_body_background">
							...
							<div class="number_box_start">
								...
								<div>
									<div class="text_form_start">
										<div class="text_box" id="confirmationCodeDescription">
											<div class="text_box_up"></div>
												<div class="up_text">마지막 단계</div>
											<div class="text_box_down">
												<div class="down_text">${user_id.user_phone}로 전송된 6자리 코드를 입력하세요</div>
											</div>
										</div>
										<form class="form_box" method="post">
											<div class="form_box_blank">
												<div class="form_box_start">
													<label class="form_box_label">
														<span id="1" class="form_span">######</span>
														<input id="1-1" aria-describedby="confirmationCodeDescription" aria-label="######" aria-required="true" autocapitalize="off" autocorrect="off" maxlength="6" name="confirmationCode" type="tel" class="form_input" value="">
													</label>
													<div class="unknown"></div>
												</div>
											</div>
											<div class="confirm_box">
												<button id="confirm_btn" class="confirm_btn" type="button"  onclick="checkAndSend_phone();">확인</button>
											</div>
										</form>
										...
										<div class="changeOrNew_box">
											<button class="btn_left" type="button" onclick="location.href='${cp}/instagram/join/join_change_phone_number.jsp'">휴대폰 번호 변경</button>
											  | 
											<button id="re_btn" class="btn_right" type="button" onclick="resend();">새 코드 요청하기</button>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="have_account">
							<p class="have_account_space">계정이 있으신가요? 
								<a class="have_account_text" data-testid="log-in-link" href="${cp}/instagram/login/login_main.jsp" tabindex="0">로그인</a> <!-- data-testid ?? -->
							</p>
						</div>
						<div class="photo_box">
	...
	<script src="${cp}/javascript/seongho/join_phone_confirmation.js"></script>
