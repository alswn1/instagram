...
<link href="${cp}/css/seongho/join/join_email_confirmation.css" rel="stylesheet" type="text/css">
</head>
...
<body>
			...
			<main class="main" role="main">
				<div class="large_body_background" style="min-height: 100%;">
					<div class="small_body_background">
						<div class="code_box_start">
							<h1 class="insta_blank">Instagram</h1>
							<!-- 여기부터 수정 -->
							<div class="text_box" style="max-width: 350px;">
								<span aria-label="이메일 확인"	 class="email_img"></span>
								<div class="text_box_start">
									<div class="text_box_text">인증 코드 입력</div>
								</div >
								<div class="email_confirm_box">
									<div class="email_confirm_text">${user_id.user_email}로 전송된 인증 코드를 입력하세요.
										<button class="resend_btn" type="button" onclick="resend();">코드 재전송.</button>
									</div>
								</div>
							</div>
							<div class ="form_box" style="width: 100%;">
								<form method="post">
									<div class="form_box_start" style="max-width: 350px;">
										<div class="code_box" style="width: 100%;">
											<input id="1-1" aria-label="인증 코드" autocomplete="false" class="code_text" maxlength="8" name="email_confirmation_code" placeholder="인증 코드" spellcheck="true" type="text" value="">
										</div>
										<div class="next_box" style="width: 100%; " > <!--  button /  submit or button 정하기 -->
											<button id="next_btn" class="next_btn" disabled type="button" onclick="checkAndSend_email();" >다음</button>
										</div>
										<div class="return_box">
											<button class="return_btn" type="button" onclick="location.href='${cp}/instagram/join/join_main.jsp'">돌아가기</button>
										</div>
										<div id="wrongText" class="wrongText" >
											<p id="text" class="text" aria-atomic="true" id="phoneSignupConfirmErrorAlert" role="alert">코드가 유효하지 않습니다. 새 코드를 요청하세요.</p>
										</div>
									</div>
								</form>
							</div>
						...
						<div class="have_account">
							<p class="have_account_space">계정이 있으신가요? 
								<a class="have_account_text" data-testid="log-in-link" href="${cp}/instagram/login/login.jsp" tabindex="0">로그인</a> 
							</p>
						</div>
						<div class="photo_box">
	...
	<script src="${cp}/javascript/seongho/join_email_confirmation.js"></script>
</body>
</html>
